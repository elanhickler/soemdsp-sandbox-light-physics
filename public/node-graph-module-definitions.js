...
const nodeGraphModuleDefinitions = Object.freeze({
  ...
  formulaVisual: {
    ...
    outputs: ["RGBA"],
    parameters: [
      { defaultValue: "3", key: "formulaA", label: "A", max: "16", maxDigits: 0, mid: "3", min: "1", nonlinearSlider: false, step: "1" },
      { defaultValue: "2", key: "formulaB", label: "B", max: "16", maxDigits: 0, mid: "2", min: "1", nonlinearSlider: false, step: "1" },
      { defaultValue: "5", key: "formulaPetals", label: "Petals", max: "24", maxDigits: 0, mid: "5", min: "1", nonlinearSlider: false, step: "1" },
      { defaultValue: "0.38", key: "formulaMix", label: "Rose Mix", max: "1", mid: "0.38", min: "0", nonlinearSlider: false, step: "any" },
      { defaultValue: "0.82", key: "formulaScale", label: "Scale", max: "1.5", mid: "0.82", min: "0.1", nonlinearSlider: false, step: "any" },
      { defaultValue: "0.12", key: "formulaRotate", label: "Rotate", max: "1", mid: "0.12", min: "0", nonlinearSlider: false, step: "any", wraparound: true },
      { defaultValue: "0.25", key: "formulaMorph", label: "Morph", max: "2", mid: "0.25", min: "0", nonlinearSlider: false, step: "any" },
      { defaultValue: "0.64", key: "formulaHue", label: "Hue", max: "1", mid: "0.64", min: "0", nonlinearSlider: false, step: "any", wraparound: true },
      { defaultValue: "0.85", key: "formulaGlow", label: "Glow", max: "1", mid: "0.85", min: "0", nonlinearSlider: false, step: "any" },
      { defaultValue: "0.55", key: "formulaDots", label: "Dots", max: "1", mid: "0.55", min: "0", nonlinearSlider: false, step: "any" },
    ],
    visualSink: true,
  },
  led: {
