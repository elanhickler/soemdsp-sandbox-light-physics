...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "nodeSceneSavedPatches",
        "nodeSceneSavedPatchesRefresh",
        "nodeSceneSavedPatchList",
        "Saved Patches",
    ...
    for snippet in [
        ...
        "function renderNodeGraphDemoPatchList(listId = \"nodeDemoPatchList\")",
    ...
    for snippet in [
        ...
        ".scene-context-saved-patches",
        ".scene-context-saved-patches[hidden]",
        ".scene-context-saved-patches-heading",
        ".scene-context-saved-patch-list",
